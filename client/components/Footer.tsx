...
const SocialButton = ({ icon: Icon, label }: { icon: React.ReactNode; label: string }) => (
  <motion.button
    ...
    <footer className="bg-slate-800 dark:bg-slate-950 text-gray-300 dark:text-gray-400 py-16 transition-colors">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          >
            <h3 className="text-white dark:text-gray-100 font-semibold mb-4">Services</h3>
          ...
          >
            <h3 className="text-white dark:text-gray-100 font-semibold mb-4">Solutions</h3>
            <ul className="space-y-3">
